...
export const AdminLayout = () => {
  ...
  return (
    ...
    >
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-[#0A0A0F] border-b border-white/[0.06] z-50 flex items-center px-4">
        ...
        <div className="ml-4">
          ...
          >
            ...
            <span className="text-[#a3b18a]">Admin</span>
          </h1>
        </div>
      </div>
      ...
      <aside
        className={`hidden lg:flex flex-col w-64 border-r fixed top-0 h-screen z-30 backdrop-blur-xl ${isDark
          ? "border-white/[0.06] bg-[#0d0d12]/95"
      ...
      >
        ...
        {/* Bottom Actions */}
        <div
          className={`pt-4 border-t ${isDark ? "border-white/[0.06]" : "border-black/[0.06]"
            }`}
        >
      ...
      {/* Sidebar - Icon-only on md */}
      <aside
        className={`hidden md:flex lg:hidden flex-col items-center w-[60px] border-r fixed top-0 h-screen z-30 py-4 backdrop-blur-xl ${isDark
          ? "border-white/[0.06] bg-[#0d0d12]/95"
          : "border-black/[0.06] bg-white/95"
          }`}
      >
        <div className="mb-6 flex items-center justify-center w-10 h-10">
          <span
            className="font-bold text-[#588157] text-lg"
            style={{ fontFamily: "'Space Grotesk', sans-serif" }}
          >
            R
          </span>
        ...
        <nav className="flex flex-col items-center gap-1 flex-1 w-full px-2">
          {navItems.map((item) => (
            ...
            >
              ...
              <span
                className={`absolute left-full ml-3 px-2 py-1 rounded-md text-xs font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-50 ${isDark
                  ? "bg-[#18181f] text-[#F5F5F0] border border-white/10"
                  : "bg-white text-[#1a1a14] border border-black/10"
                  }`}
              >
                {item.label}
              </span>
        ...
        <div
          className={`pt-4 border-t w-full flex flex-col items-center gap-2 px-2 ${isDark ? "border-white/[0.06]" : "border-black/[0.06]"
            }`}
        >
          <Link
            to="/"
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.aside
              ...
              className={`md:hidden fixed top-16 left-0 bottom-0 w-[280px] flex flex-col border-r backdrop-blur-xl z-40 ${isDark
                ? "border-white/[0.06] bg-[#0d0d12]/98"
