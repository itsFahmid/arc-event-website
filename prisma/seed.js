...
async function main() {
  ...
  // 6. Seed Segments
  const segments = [
    { name: 'Robo Soccer', description: 'Build and program autonomous or manual robots to compete in a high-stakes soccer tournament.', rules: '1. Robots must fit within dimensions. 2. Manual control via wireless RF. 3. No damage to arena.', prizePool: '৳20,000', category: 'Manual', type: 'Team', difficulty: 'Hard', teamSize: 'Max 4 members', fee: '৳500', deadline: 'May 15, 2026', location: 'Arena A, Main Hall', scheduleText: 'Day 1 • May 20, 2026 • 10:00 AM', highlights: ['Custom-built arena with professional soccer field layout', 'Real-time strategy and quick decision-making required', 'Team coordination essential for victory'], status: 'active', imageUrl: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=800&q=80' },
    { name: 'Line Follower', description: 'Optimize your algorithms for the fastest time across complex track layouts.', rules: '1. Autonomous control only. 2. Max weight 1kg. 3. Time trial base scoring.', prizePool: '৳15,000', category: 'Autonomous', type: 'Team', difficulty: 'Medium', teamSize: 'Max 3 members', fee: '৳400', deadline: 'May 12, 2026', location: 'Track B, Engineering Wing', scheduleText: 'Day 1 • May 20, 2026 • 2:00 PM', highlights: ['Complex track with sharp turns and intersections', 'Sensor calibration and PID tuning critical', 'Time-based scoring system'], status: 'active', imageUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80' },
    { name: 'Drone Race', description: 'Navigate aerial obstacles in a high-speed FPV drone racing championship.', rules: '1. Quadcopter design only. 2. Safety nets active. 3. FPV video feed mandatory.', prizePool: '৳50,000', category: 'Manual', type: 'Solo', difficulty: 'Extreme', teamSize: 'Solo (Max 1)', fee: '৳1000', deadline: 'May 10, 2026', location: 'Sky Zone, Outdoor Arena', scheduleText: 'Day 2 • May 21, 2026 • 11:00 AM', highlights: ['Professional FPV racing course with multiple obstacles', 'Real-time video feed from drone camera', 'Safety nets and crash recovery zones'], status: 'active', imageUrl: 'https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=800&q=80' },
    { name: 'Sumo Bot', description: 'Push the opponent out of the ring. Pure torque and grip.', rules: '1. Auton/Manual options. 2. Ring size 1.5m diameter. 3. Weight limits apply.', prizePool: '৳25,000', category: 'Autonomous', type: 'Team', difficulty: 'Hard', teamSize: 'Max 4 members', fee: '৳600', deadline: 'May 14, 2026', location: 'Ring C', scheduleText: 'Day 1 • May 20, 2026 • 4:00 PM', highlights: ['High-torque robot design challenge', 'Ring-out scoring format', 'Weight limits apply'], status: 'active', imageUrl: 'https://images.unsplash.com/photo-1535378917042-10a22c95931a?w=800&q=80' },
  ];
  ...
  const scheduleItems = [
    ...
    { segmentId: dbSegments[1].id, title: 'LFR1 - Qualifying', startTime: new Date('2026-06-10T14:00:00Z'), endTime: new Date('2026-06-10T17:00:00Z'), venue: 'Track Beta', displayOrder: 2 },
